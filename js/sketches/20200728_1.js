...
// Union
var union = ellipses[0];
for (var i = 0; i < ellipses.length; i++) {
  union = union.unite(ellipses[(i + 1) % ellipses.length]);
  union.fillColor = new Color(1, 1, 1, 0);
}
union.strokeColor = new Color(0, 0, 0, 1);
union.strokeWidth = 1;
union.sendToBack();
